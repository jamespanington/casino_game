<?php $__env->startSection('page_title'); ?> Login <?php $__env->stopSection(); ?>
    ...
    <div class="left_blank_img bgim-l mobile_tag">
        ...
        <div class="col-md-4">
            <div class="row how__faq">
                ...
                <a href="<?php echo e(route('how_play')); ?>" class="m__how"><button type="submit" class="auth-button m-how"
                        style="width:100%">How to play</button></a>
                <a href="<?php echo e(route('faq')); ?>" class="m__faq"><button type="submit" class="auth-button m-faq"
        ...
        <div class="col-md-4">
            <div class="row log__sign">
                <a href="<?php echo e(route('login')); ?>" class="m__log"><button type="submit" class="auth-button m-log"
                        style="width:100%">LOGIN</button></a>
                <a href="<?php echo e(route('register')); ?>" class="m__sign"><button type="submit" class="auth-button m-sign"
        ...
        <div class="row certain-container remove-before" style="height: 100%;">
            <div class="col-md-12 auth-container background-spin-container"
                ...
                <div class="row navbar-container nav-bar" style="position: unset;margin-right: 0;margin-left: 0;">
                    <div class="hamburger-btn-container"> 
                        <a href="<?php echo e(route('welcome')); ?>">
                            <img src="<?php echo e(asset('images/hamburger_close_btn.png')); ?>" class="close_btn" style="width:15%" alt="">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-12 register-container background-spin-container">
                    ...
                    <form class="" action="<?php echo e(route('login')); ?>" method="post" id="signin_form">
                        <?php echo e(csrf_field()); ?>

                        <div class="input-container">
                            <div class="form-group">
                                <label for="email">*Email</label>
                                <input class="form-control" type="email" id="email" name="email" placeholder="Email" value="" style="font-family: arial;">
                            </div>
                            <div class="form-group">
                                <label for="password">*Password</label>
                                <input class="form-control" type="password" id="password" name="password" placeholder="Password" value="" style="font-family: arial;">
                            </div>
                        </div>
                        <div class="button-container">
                            <button type="submit" class="auth-button" >LOG IN</button><br>
                        ...
                        <!-- <div class="button-container">
                            <a href=""> 
                                <button type="submit" class="auth-button facebook" style="padding: unset;" >
                                   <div class="container">
                                       <div class="row">
                                            <div class="col-md-3"></div>
                                            <div class="col-md-9 login-tag">LOGIN WITH FACEBOOK</div>
                                        </div>
                                   </div>
                        ...
                        <div class="button-container sign-login" style="padding-top: 10px">
                ...
                <div class="col-md-12" style="text-align: center;">
                         <img src="<?php echo e(asset('html/images/half_spin.png')); ?>" class="register-img" style="width:50%" alt="" />
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.authMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\Web\Laravel\spingame\resources\views/auth/login.blade.php ENDPATH**/ ?>