...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('html/css/font.css')); ?>" />
            ...
            <div class="row navbar-container" style="border: 6px dotted #feec8c;">
                ...
                <div class="hamburger-btn-container">
                    <a href="<?php echo e(route('welcome')); ?>">
                        <img src="<?php echo e(asset('images/hamburger_close_btn.png')); ?>" class="close_btn" style="width:100%"
                            alt="">
                    </a>
                </div>
                <?php endif; ?>
            ...
            <div class="row sidebar-container" id="sidebar_container">
                ...
                <div class="menu-container" style='-webkit-overflow-scrolling:touch;'>
                    <ul>
                        ...
                        <li> <a style="text-transform: none" href="<?php echo e(route('faq')); ?>">FAQ's</a> </li>
            ...
            <div class="row certain-container" style="    height: unset;">
                ...
                <div class="home_container how_play_content" style='-webkit-overflow-scrolling:touch;'>
                            ...
                            <div class="col-md-6 text-body">
                                ...
                                <p class="how-content">
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-md-6"><a href="<?php echo e(route('contact')); ?>"><button type="submit"
                                                    class="auth-button help-last"
                            ...
                            <div class="col-md-6" style="margin: auto;">
                                    <div class="row">
                                        <div class="col-md-12" style="text-align:center;">
                                            <img src="<?php echo e(asset('html/images/new_spin.png')); ?>" class="spin-m d-md-block"
                    ...
                    <div class="col-md-12" style="text-align:center;">
                        ...
                        <p class="footer" style="color:white;">For any other questions visit the <a href="<?php echo e(route('faq')); ?>" class="m__faq" >FAQ</a> page or <a href="<?php echo e(route('contact')); ?>" >Help</a> page.</p>
                    </div>
                </div>
                                ...
                                <div class="main-container m-home-screen">
                                    <div class="" style="position: relative;margin-right: 0;margin-left: 0;">
                                        ...
                                        <div class="row certain-container modal-container" >
                                            <!--<img src="<?php echo e(asset('images/left_certain.png')); ?>" class="left_blank_img" alt="">
                                            <img src="<?php echo e(asset('images/right_certain.png')); ?>" class="right_blank_img" alt="">-->
                                            ...
                                            <div class="home_container m-home_container ">
                                                ...
                                                <div class="circle-img-container">
                                                    <div id="spinboard" class="spin-container m-spin-img-container" style="display:none">
                                                        ...
                                                        <img id="spiner" src="<?php echo e(asset('html/images/new_spin.png')); ?>" style="cursor:pointer; width:100%">
...
</html><?php /**PATH E:\Project\Web\Laravel\spingame\resources\views/how_to_play.blade.php ENDPATH**/ ?>