					...
					<?php else: ?>
						<div class="hamburger-btn-container"> 
							<a href="<?php echo e(route('welcome')); ?>">
								<img src="<?php echo e(asset('images/hamburger_close_btn.png')); ?>" class="close_btn" style="width:100%" alt="">
							</a>
						</div>
					<?php endif; ?>
                </div>
                <div class="row sidebar-container" id="sidebar_container">
                    ...
                    <div class="menu-container" style='-webkit-overflow-scrolling:touch;'>
                        <ul>
							...
							<li> <a href="<?php echo e(url('invite')); ?>">Invite Friends</a> </li>
				    ...
				    <div class="row certain-container">
				        ...
				        <img src="<?php echo e(asset('images/right_certain.png')); ?>" class="right_blank_img" alt=""> -->
				        	<!-- <div class="sound-icon-container w-sound" >
				            		<a href="#" onclick="bgm_on(0)" style="display: inline-block;cursor: pointer;"><img src="<?php echo e(asset('images/sound_icon.png')); ?>" alt=""></a>
						        </div> -->
						...
						<h1 class="" style="height:40px"></h1>
							...
							<div class="input-container form-group <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
							<label>Name:</label>
							<input type='name' name='name' class='form-control' placeholder='Enter Name' />
							<span class="text-danger"><?php echo e($errors->first('name')); ?></span>
							</div>

							<div class="input-container form-group <?php echo e($errors->has('email') ? 'has-error' : ''); ?>">
							<label>Email:</label>
							<input name='email' type='email' class='form-control' placeholder='Enter Email' />
							<span class="text-danger"><?php echo e($errors->first('email')); ?></span>
							</div>

							<div class="input-container form-group <?php echo e($errors->has('message') ? 'has-error' : ''); ?>">
							<label>Message:</label>
							...
							<div class="row social-icon" style="margin-right: 0;margin-left: 0;">
								...
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<a href="http://www.facebook.com/">
										<img src="<?php echo e(asset('images/fb.png')); ?>" alt="">
									</a>
								</div>
							</div>
						</div>
...
</html><?php /**PATH E:\Project\Web\Laravel\spingame\resources\views/contact.blade.php ENDPATH**/ ?>