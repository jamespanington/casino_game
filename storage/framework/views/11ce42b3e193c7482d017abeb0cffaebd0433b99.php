...
<html lang="en">
  <head>
    ...
    <link href="<?php echo e(asset('/lib/datatables/css/jquery.dataTables.css')); ?>" rel="stylesheet">

    <link href="<?php echo e(asset('/lib/rickshaw/css/rickshaw.min.css')); ?>" rel="stylesheet">
    ...
    <script src="<?php echo e(asset('/lib/jquery.cookie/js/jquery.cookie.js')); ?>"></script>
    <script src="<?php echo e(asset('/lib/datatables/js/jquery.dataTables.js')); ?>"></script>
    <script src="<?php echo e(asset('/lib/datatables-responsive/js/dataTables.responsive.js')); ?>"></script>
    <script src="<?php echo e(asset('/lib/select2/js/select2.min.js')); ?>"></script>
    <script src="<?php echo e(asset('/lib/d3/js/d3.js')); ?>"></script>
    <script src="<?php echo e(asset('/lib/rickshaw/js/rickshaw.min.js')); ?>"></script>
    <script src="<?php echo e(asset('/lib/Flot/js/jquery.flot.js')); ?>"></script>
    <script src="<?php echo e(asset('/lib/Flot/js/jquery.flot.resize.js')); ?>"></script>
    <script src="<?php echo e(asset('/lib/peity/js/jquery.peity.js')); ?>"></script>
  ...
  <body class="dashboard-3 slim-full-width">
    <div class="slim-header">
      <div class="container">
        <div class="slim-header-left">
          <h2 class="slim-logo"><a href="<?php echo e(route('admin.home')); ?>">Awoof Spin Admin Panel<span>.</span></a></h2>
        ...
        <div class="slim-header-right">
          <div class="dropdown dropdown-c">
            <a href="#" class="logged-user" data-toggle="dropdown">
              ...
              <span id="span_admin_name"><?php echo e(Session::get('admin_name')); ?></span>
            ...
            <div class="dropdown-menu dropdown-menu-right">
              <nav class="nav">
                ...
                <a href="<?php echo e(route('admin.logout')); ?>" class="nav-link"><i class="icon ion-forward"></i> Sign Out</a>
              </nav>
            </div><!-- dropdown-menu -->
          </div><!-- dropdown -->
        </div><!-- header-right -->
    ...
    <div class="slim-navbar">
      <div class="container">
        <ul class="nav">
          <li class="nav-item with-sub <?php echo e(Request::is('admin')?'active':''); ?> <?php echo e(Request::is('admin/prizes')?'active':''); ?>">
            <a class="nav-link" href="<?php echo e(route('admin.home')); ?>">
              <i class="icon ion-easel"></i>
              <span>Prize</span>
            </a>
          </li>
          <li class="nav-item with-sub <?php echo e(Request::is('admin/users*')?'active':''); ?>">
            <a class="nav-link" href="<?php echo e(route('admin.users')); ?>">
              <i class="icon ion-person"></i>
              <span>Users</span>
            </a>
          </li>
          <li class="nav-item with-sub <?php echo e(Request::is('admin/tokenbuyhistory')?'active':''); ?>">
            <a class="nav-link" href="<?php echo e(route('admin.tokenbuyhistory')); ?>">
              <i class="icon ion-ios-book-outline"></i>
              <span>Transactions</span>
            </a>
          </li>
          <li class="nav-item with-sub <?php echo e(Request::is('admin/prizewinners')?'active':''); ?>">
            <a class="nav-link" href="<?php echo e(route('admin.prizewinners')); ?>">
              <i class="icon ion-flag"></i>
              <span>Prize Winners</span>
            </a>
          </li>
          <li class="nav-item with-sub <?php echo e(Request::is('admin/imgupload')?'active':''); ?>">
            <a class="nav-link" href="<?php echo e(route('admin.imgupload')); ?>">
            <i class="icon ion-ios-gear-outline"></i>
              <span>Scroll Text/Images Edit</span>
            </a>
          </li>
  ...
  <div id="modaleditadmin" class="modal fade">
              ...
              <div class="form-layout form-layout-5">
                <div class="row">
                  ...
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input type="text" class="form-control" id="admin_id" value="<?php echo e(Session::get('admin_id')); ?>">
                  </div>
                </div><!-- row -->
                <div class="row mg-t-20">
                  <label class="col-sm-4 form-control-label">admin name:</label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input type="email"  class="form-control" id="admin_name" value="<?php echo e(Session::get('admin_name')); ?>">
                  </div>
                </div>
                <div class="row mg-t-20">
                  <label class="col-sm-4 form-control-label">admin email:</label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input type="text" class="form-control" id="admin_email" value="<?php echo e(Session::get('admin_email')); ?>">
                  </div>
                </div>
                <div class="row mg-t-20">
    ...
    function admineditaction (){
        ...
        $.post("<?php echo e(route('admin.passwordchange')); ?>",{
...
<?php /**PATH E:\Project\Web\Laravel\spingame\resources\views/admin/layouts/default.blade.php ENDPATH**/ ?>