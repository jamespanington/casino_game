...
<div class="container">
    <div class="slim-pageheader">
        <ol class="breadcrumb slim-breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('AdminprizeExport')); ?>">Export Prize</a></li>
        </ol>
            ...
            <table id="datatable" class="table display responsive wrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td onclick="editrow(<?php echo e($prize->id); ?>)"   style="cursor:pointer"><img width="80" src='<?php echo e($prize->img_url); ?>' /></td>
                        <td><?php echo e($prize_category[$prize->prize_category]); ?></td>
                        <td><?php echo e($prize->prize_name); ?></td>
                        <td><?php echo e($prize->prize_cost); ?></td>
                        <td><?php echo e($prize->start_time); ?></td>
                        <td><?php echo e(strtotime($prize->expire_time)<(time()+3600)?"expired":"active"); ?></td>
                        <td><?php echo e($prize->token_count); ?></td>
                        <td><?php echo e($prize->user_count); ?></td>
                        <td><?php echo $prize->description ?></td>
                        <td>
                            <button class="btn btn-secondary btn-sm active wd-30" onclick="javascript:location.href='<?php echo e(route('admin.prizewinners')); ?>?prize=<?php echo e($prize->id); ?>'"><i class="icon ion-search"></i></button>
                            <button class="btn btn-primary btn-sm active wd-30" onclick="editrow(<?php echo e($prize->id); ?>)"><i class="icon ion-wrench"></i></button>
                            <button class="btn btn-secondary btn-sm active wd-30" onclick="deleterow(<?php echo e($prize->id); ?>)"><i class="icon ion-trash-a"></i></button>
                        </td>
                    </tr>
    ...
    var prizeCheck = 0;
        ...
        $(document).ready(function(){
            ...
            $("#img_upload").change(function() {
               var data=new FormData($("#modal_form")[0]);
                $.ajax({
                    url: "<?php echo e(route('ajaximgupload')); ?>", // Url to which the request is send
                    type: "POST",
                    data:data,
        ...
        function editrow(id){
            $.getJSON("<?php echo e(route('admin.prizeinfojson')); ?>", {id:id}, function(data){
                $('#id').val(data.id);
                $('#task').val('edit');
        ...
        function editrowaction (){
          ...
          if($('#cash_price').val()==''){
            ...
            var url="<?php echo e(route('admin.prizeeditaction')); ?>";
            if($('#task').val()=="addnew"){
                url="<?php echo e(route('admin.prizeaddaction')); ?>";
            }
            $.post(url, {
                // headers: {
        ...
        $.post("<?php echo e(route('admin.prizedeleteaction')); ?>", {
        _token:$('meta[name=csrf-token]').attr("content"),
                id:selecte_row_id,
        }, function(data){
        if (data == "success"){
        location.href = "<?php echo e(route('admin.prizes')); ?>"
        } else{
        $('#errormodal').modal('show');
        }
        });
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\Web\Laravel\spingame\resources\views/admin/prizes.blade.php ENDPATH**/ ?>