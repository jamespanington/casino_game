            ...
            <table id="usestable" class="table display responsive ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td onclick="edituser({{$user['id']}})"   style="cursor:pointer">{{$user['firstname'], $user['lastname']}}</td>
                  <td>{{$user['email']}}</td>
                  ...
                  <td>
                      <button class="btn btn-secondary btn-sm active wd-40" onclick="javascript:location.href='{{route('admin.prizewinners')}}?user={{$user['id']}}'"><i class="icon ion-search"></i></button>
                      <button class="btn btn-primary btn-sm active wd-40" onclick="edituser({{$user['id']}})"><i class="icon ion-wrench"></i></button>
                      <button class="btn btn-secondary btn-sm active wd-40" onclick="userdelete({{$user['id']}})"><i class="icon ion-trash-a"></i></button>
                  </td>
                </tr>
                @endforeach
              </tbody>
