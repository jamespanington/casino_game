    ...
    <div class="slim-header">
      <div class="container">
        <div class="slim-header-left">
          <h2 class="slim-logo"><a href="{{route('admin.home')}}">Awoof Spin Admin Panel<span>.</span></a></h2>
    ...
    <div class="slim-navbar">
      <div class="container">
        <ul class="nav">
          ...
          <li class="nav-item with-sub {{Request::is('admin/imgupload')?'active':''}}">
            <a class="nav-link" href="{{route('admin.imgupload')}}">
