            ...
            <div class="col-md-12 auth-container background-spin-container" style="padding-top:0px;height: 100%;-webkit-overflow-scrolling:touch;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 slide-img">
                        @foreach($descriptionImgs_array as $key=>$descriptionImg_url)
                            <img class="w3-animate-left description_img secimg" src="{{url('/uploads/description_image/'.basename($descriptionImgs_array[$key]))}}">
                        @endforeach
                    </div> 
