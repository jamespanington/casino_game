...
<div class="main-container home-screen">
            <div class="container background-spin-img-container" style="position: relative;">
                <div class="row navbar-container" style="border: 4px dotted #feec8c;">
                    ...
                    <div class="buytoken_container">
                            ...
                            <div class="col-md-6 buytoken_box">
                                ...
                                <div class="buytoken_input_container">
                                    <div>
                                        ...
                                        @else
                                            <span class="buytoken_minplus" id="halftoken_nonplus">+</span>
                                        @endif
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12" style="text-align: center;">
                                <img src="{{asset('images/fund3.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                ...
                <script>
                    ...
                    $(document).ready(function() {                        
                        ...
                        $("#halftoken_nonplus").click(function() {
                            swal({
                                position: 'top-center',
                                showConfirmButton: false,
                                timer: 4000,
                                title: "Half tokens can only be purchased if they have been won as a prize!",
                                type: "error"
                            });
                            return false;
